  ...
  def manifest
    record do |m|\
      m.migration_template 'migration.rb', 'db/migrate', :assigns => {
        :migration_name => "CreatePolls",
        :table_name => :polls
      }, :migration_file_name => "create_polls"
      
      m.migration_template 'migration.rb', 'db/migrate', :assigns => {
        :migration_name => "CreatePollVotes",
        :table_name => :poll_votes
      }, :migration_file_name => "create_poll_votes"
      
      m.route_resources "polls"
      m.route_resources "poll_votes"
    end
  end
